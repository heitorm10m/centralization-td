...
def require_centralizer_segment_6dof(segment: object) -> None:
    _nodal_output_6dof = require_nodal_output_6dof(
        segment,
        context="centralizer torque/drag evaluation",
    )
    # The current centralizer torque closure consumes bow-resultant/contact
    # quantities already reduced onto the segment. Rotational DOFs are checked
    # explicitly so interface mismatches fail loudly instead of being ignored.
