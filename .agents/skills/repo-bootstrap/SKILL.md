---
name: repo-bootstrap
description: Scaffold or reorganize a scientific computing repository for hybrid C++ and Python development. Use when the task is to create base folders, build files, environment setup, examples, tests, and first-pass documentation.
---
...
- Keep the numerical core in C++ and orchestration in Python.
