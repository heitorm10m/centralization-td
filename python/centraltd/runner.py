...
def _mechanical_result(loaded_case: LoadedCase) -> dict[str, Any]:
    ...
    return {
        ...
        "message": (
            ...
            "centralizer torque now distinguish pipe-body and bow-spring contributions, use a "
            "contact-informed reduced tangential law tied to the local contact direction plus bow "
            "resultant, propagate a reduced torsional-load/twist state with GJ-based twist "
            "indicators, and now let the carried reduced torsional state feed a shared reduced "
            "local tangential-state model with slip indicator, mobilization, traction "
            "indicator, and regime fields before applying the body and centralizer tangential "
            "laws. The updated local centralizer demand still affects the axial coupling loop, "
            "while both local tangential laws affect the carried "
            "torsional state without claiming a full torsional "
            "structural solve. "
