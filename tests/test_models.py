...
def test_phase9_payload_contains_bow_spring_outputs(tmp_path: Path) -> None:
    case_path = ROOT / "examples" / "minimal_case.yaml"
    loaded_case, payload, output_path = run_stub_case(case_path, tmp_path / "phase9-output.json")
